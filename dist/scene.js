...
class Scene extends scene_ssr_1.SceneSSR {
    constructor(_a = {}) {
        var { view } = _a, options = __rest(_a, ["view"]);
        super(options);
    ...
    static getQueryParams() {
        ...
        return [...matches].reduce((queryParams, [_wholeMatch, paramName, paramValue]) => (Object.assign(Object.assign({}, queryParams), { [decodeURIComponent(paramName)]: decodeURIComponent(paramValue) })), {});
    }
    createPixi(options) {
    ...
    async init(options) {
        ...
        await ((_a = pixi.init) === null || _a === void 0 ? void 0 : _a.call(pixi, options));
    ...
    stop() {
        var _a, _b;
        (_b = (_a = this.pixi) === null || _a === void 0 ? void 0 : _a.stop) === null || _b === void 0 ? void 0 : _b.call(_a);
        super.stop();
    }
    destroy() {
        var _a;
        super.destroy();
        (_a = this.pixi) === null || _a === void 0 ? void 0 : _a.stage.removeChild(this.stage);
    }
     ...
     */
    showFPS(style) {
        const stats = new pixi_stats_1.Stats(this.pixi.renderer, this.pixi.ticker, document.body);
        if (style) {
    ...
    onUpdateDebug(graphics) {
        ...
        const debug = typeof this.options.debug === 'object' ? this.options.debug : {};
        graphicsUniversal.clear();
        if (!isPIXIv6) {
            graphicsUniversal.lineStyle(((_a = debug.debugStroke) === null || _a === void 0 ? void 0 : _a.width) || 1.5, ((_b = debug.debugStroke) === null || _b === void 0 ? void 0 : _b.color) || 0xffffff, ((_c = debug.debugStroke) === null || _c === void 0 ? void 0 : _c.alpha) || 1);
        }
        this.physics.draw(context);
        if (isPIXIv6) {
            graphicsUniversal.stroke(debug.debugStroke || {
                color: 0xffffff,
                width: 1.5,
                alpha: 1
            });
        ...
        if (!isPIXIv6) {
            graphicsUniversal.lineStyle(((_d = debug.debugBVHStroke) === null || _d === void 0 ? void 0 : _d.width) || 1, ((_e = debug.debugBVHStroke) === null || _e === void 0 ? void 0 : _e.color) || 0x00ff00, ((_f = debug.debugBVHStroke) === null || _f === void 0 ? void 0 : _f.alpha) || 0.5);
        }
        this.physics.drawBVH(context);
        if (isPIXIv6) {
            graphicsUniversal.stroke(debug.debugBVHStroke || {
                color: 0x00ff00,
                width: 1,
                alpha: 0.5
            });
